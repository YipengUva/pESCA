...
% Fig.~7 shows the thresholding paths during the
...
%% how CV errors change with respect to the value of lambda
...
snapnow
disp(sprintf(['Fig.~6: How CV errors change during the model selection ' ...
...
xlabel('log_{10}(\lambda)');
snapnow
disp('Fig.~7: Thresholding pathes of the model selection of the P-ESCA model.');
...
% $\mathbf{\Theta}_3$ and $\mu$ are shown as RMSEs_parameters. Fig.~8 shows
...
xlabel('components');
snapnow
disp('Fig.~8: The estimated variation explained ratios.');
