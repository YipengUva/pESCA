...
% P-ESCA model with a group GDP penalty is used. Fig.~4
...
% to the minimum CV error. Fig.~5 shows the thresholding paths during the
...
snapnow
disp(sprintf(['Fig.~3: How CV errors, RMSEs and RV coefficients \n ' ...
...
legend('D1','D2','D3','Location','best')
snapnow
disp(sprintf(['Fig.~4: How rank estimations of the estimated structures \n' ... 
    'change during the model selection process of the P-ESCA model.']));
...
xlabel('log_{10}(\lambda)');
snapnow
disp('Fig.~5: Thresholding pathes of the model selection of the P-ESCA model.');
